...
public class testCase17 {
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		commonutils.generateReport("/Users/nithya/eclipse-workspace/com.TekArch.Salesforce/salesForceReports/opportunitypipeline.html", "TC17");
		...
		opportunities.clickOpportunityPipeline();
		
		commonutils.logger.log(LogStatus.PASS, "Report page with opportunities are pipelined ");
